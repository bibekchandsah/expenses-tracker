                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {PROVIDERS.map(({ key, label, icon }) => (
                    <button
                      ...
                      disabled={anyBusy}
                      className="flex items-center justify-center gap-2.5 w-full px-3 py-2.5 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 hover:border-gray-300 dark:hover:border-gray-500 disabled:opacity-50 transition-all sm:last:col-span-2"
                    >
                      {busy === key
