...
import { X, Smile, Check, Pin } from 'lucide-react';
...
export default function CategoryModal({ isOpen, category, onClose, onSave, pinned = false, onPinnedChange }) {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md animate-slide-in flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          ...
          <div className="flex items-center gap-1">
            ...
            <button onClick={onClose} className="p-1.5 rounded-lg text-gray-400 hover:text-gray-600 dark:hover:bg-gray-700 transition-colors">
              <X className="w-5 h-5" />
            </button>
          </div>
        </div>
          ...
          <div className="p-6 space-y-5 overflow-y-auto">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                ...
                <input ref={colorRef} type="color" value={form.color} onChange={e => setForm(f => ({ ...f, color: e.target.value }))} className="sr-only" />
              </div>
              <div className="flex items-center gap-2 mt-1">
                ...
                <input
                  ...
                  value={form.color}
                  maxLength={7}
                  onChange={e => { const v = e.target.value; if (/^#[0-9a-fA-F]{0,6}$/.test(v)) setForm(f => ({ ...f, color: v })); }}
